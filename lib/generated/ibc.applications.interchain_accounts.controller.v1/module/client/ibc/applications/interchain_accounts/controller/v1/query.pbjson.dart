...
final $typed_data.Uint8List queryInterchainAccountRequestDescriptor = $convert.base64Decode('Ch1RdWVyeUludGVyY2hhaW5BY2NvdW50UmVxdWVzdBIUCgVvd25lchgBIAEoCVIFb3duZXISPQoNY29ubmVjdGlvbl9pZBgCIAEoCUIY8t4fFHlhbWw6ImNvbm5lY3Rpb25faWQiUgxjb25uZWN0aW9uSWQ=');
...
final $typed_data.Uint8List queryInterchainAccountResponseDescriptor = $convert.base64Decode('Ch5RdWVyeUludGVyY2hhaW5BY2NvdW50UmVzcG9uc2USGAoHYWRkcmVzcxgBIAEoCVIHYWRkcmVzcw==');
...
const QueryParamsResponse$json = const {
  ...
  '2': const [
    const {'1': 'params', '3': 1, '4': 1, '5': 11, '6': '.ibc.applications.interchain_accounts.controller.v1.Params', '10': 'params'},
  ],
};

/// Descriptor for `QueryParamsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryParamsResponseDescriptor = $convert.base64Decode('ChNRdWVyeVBhcmFtc1Jlc3BvbnNlElIKBnBhcmFtcxgBIAEoCzI6LmliYy5hcHBsaWNhdGlvbnMuaW50ZXJjaGFpbl9hY2NvdW50cy5jb250cm9sbGVyLnYxLlBhcmFtc1IGcGFyYW1z');
