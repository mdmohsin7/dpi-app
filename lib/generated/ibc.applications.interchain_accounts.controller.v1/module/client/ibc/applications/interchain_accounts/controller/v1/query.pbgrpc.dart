...
class QueryClient extends $grpc.Client {
  static final _$interchainAccount = $grpc.ClientMethod<
          $0.QueryInterchainAccountRequest, $0.QueryInterchainAccountResponse>(
      ...
      ($core.List<$core.int> value) =>
          $0.QueryInterchainAccountResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.QueryInterchainAccountResponse> interchainAccount(
      $0.QueryInterchainAccountRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class QueryServiceBase extends $grpc.Service {
  ...
  QueryServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.QueryInterchainAccountRequest,
            $0.QueryInterchainAccountResponse>(
        'InterchainAccount',
        interchainAccount_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.QueryInterchainAccountRequest.fromBuffer(value),
  ...
  $async.Future<$0.QueryInterchainAccountResponse> interchainAccount_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.QueryInterchainAccountRequest> request) async {
  ...
  $async.Future<$0.QueryInterchainAccountResponse> interchainAccount(
      $grpc.ServiceCall call, $0.QueryInterchainAccountRequest request);
