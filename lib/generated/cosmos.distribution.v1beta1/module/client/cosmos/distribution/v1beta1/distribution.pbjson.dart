...
const Params$json = const {
  ...
  '2': const [
    ...
    const {'1': 'withdraw_addr_enabled', '3': 4, '4': 1, '5': 8, '10': 'withdrawAddrEnabled'},
  ],
  '7': const {},
};

/// Descriptor for `Params`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List paramsDescriptor = $convert.base64Decode('');
...
const ValidatorHistoricalRewards$json = const {
  ...
  '2': const [
    ...
    const {'1': 'reference_count', '3': 2, '4': 1, '5': 13, '10': 'referenceCount'},
  ],
};

/// Descriptor for `ValidatorHistoricalRewards`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List validatorHistoricalRewardsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List validatorOutstandingRewardsDescriptor = $convert.base64Decode('ChtWYWxpZGF0b3JPdXRzdGFuZGluZ1Jld2FyZHMSawoHcmV3YXJkcxgBIAMoCzIcLmNvc21vcy5iYXNlLnYxYmV0YTEuRGVjQ29pbkIzqt8fK2dpdGh1Yi5jb20vY29zbW9zL2Nvc21vcy1zZGsvdHlwZXMuRGVjQ29pbnPI3h8AUgdyZXdhcmRz');
@$core.Deprecated('Use validatorSlashEventDescriptor instead')
const ValidatorSlashEvent$json = const {
  '1': 'ValidatorSlashEvent',
  '2': const [
    const {'1': 'validator_period', '3': 1, '4': 1, '5': 4, '10': 'validatorPeriod'},
...
final $typed_data.Uint8List validatorSlashEventDescriptor = $convert.base64Decode('ChNWYWxpZGF0b3JTbGFzaEV2ZW50EikKEHZhbGlkYXRvcl9wZXJpb2QYASABKARSD3ZhbGlkYXRvclBlcmlvZBJYCghmcmFjdGlvbhgCIAEoCUI80rQtCmNvc21vcy5EZWPa3h8mZ2l0aHViLmNvbS9jb3Ntb3MvY29zbW9zLXNkay90eXBlcy5EZWPI3h8AUghmcmFjdGlvbg==');
...
final $typed_data.Uint8List validatorSlashEventsDescriptor = $convert.base64Decode('ChRWYWxpZGF0b3JTbGFzaEV2ZW50cxJsChZ2YWxpZGF0b3Jfc2xhc2hfZXZlbnRzGAEgAygLMjAuY29zbW9zLmRpc3RyaWJ1dGlvbi52MWJldGExLlZhbGlkYXRvclNsYXNoRXZlbnRCBMjeHwBSFHZhbGlkYXRvclNsYXNoRXZlbnRzOgSYoB8A');
...
final $typed_data.Uint8List feePoolDescriptor = $convert.base64Decode('CgdGZWVQb29sEngKDmNvbW11bml0eV9wb29sGAEgAygLMhwuY29zbW9zLmJhc2UudjFiZXRhMS5EZWNDb2luQjPI3h8Aqt8fK2dpdGh1Yi5jb20vY29zbW9zL2Nvc21vcy1zZGsvdHlwZXMuRGVjQ29pbnNSDWNvbW11bml0eVBvb2w=');
...
final $typed_data.Uint8List communityPoolSpendProposalDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use delegatorStartingInfoDescriptor instead')
const DelegatorStartingInfo$json = const {
  '1': 'DelegatorStartingInfo',
  '2': const [
    const {'1': 'previous_period', '3': 1, '4': 1, '5': 4, '10': 'previousPeriod'},
...
final $typed_data.Uint8List delegatorStartingInfoDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List delegationDelegatorRewardDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List communityPoolSpendProposalWithDepositDescriptor = $convert.base64Decode('');
