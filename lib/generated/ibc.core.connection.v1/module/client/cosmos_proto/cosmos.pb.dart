...
class InterfaceDescriptor extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InterfaceDescriptor', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos_proto'), createEmptyInstance: create)
...
class ScalarDescriptor extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ScalarDescriptor', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos_proto'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..pc<ScalarType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fieldType', $pb.PbFieldType.PE, valueOf: ScalarType.valueOf, enumValues: ScalarType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ScalarDescriptor copyWith(void Function(ScalarDescriptor) updates) => super.copyWith((message) => updates(message as ScalarDescriptor)) as ScalarDescriptor; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ScalarDescriptor create() => ScalarDescriptor._();
  ScalarDescriptor createEmptyInstance() => create();
  static $pb.PbList<ScalarDescriptor> createRepeated() => $pb.PbList<ScalarDescriptor>();
  @$core.pragma('dart2js:noInline')
  static ScalarDescriptor getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ScalarDescriptor>(create);
...
class Cosmos {
  static final implementsInterface = $pb.Extension<$core.String>.repeated(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.protobuf.MessageOptions', const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'implementsInterface', 93001, $pb.PbFieldType.PS, check: $pb.getCheckFunction($pb.PbFieldType.PS));
  ...
  static final scalar = $pb.Extension<$core.String>(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.protobuf.FieldOptions', const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scalar', 93002, $pb.PbFieldType.OS);
  static final declareInterface = $pb.Extension<InterfaceDescriptor>.repeated(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.protobuf.FileOptions', const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'declareInterface', 793021, $pb.PbFieldType.PM, check: $pb.getCheckFunction($pb.PbFieldType.PM), subBuilder: InterfaceDescriptor.create);
  static final declareScalar = $pb.Extension<ScalarDescriptor>.repeated(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.protobuf.FileOptions', const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'declareScalar', 793022, $pb.PbFieldType.PM, check: $pb.getCheckFunction($pb.PbFieldType.PM), subBuilder: ScalarDescriptor.create);
