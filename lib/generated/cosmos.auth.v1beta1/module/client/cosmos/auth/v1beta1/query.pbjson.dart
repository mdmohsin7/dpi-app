...
final $typed_data.Uint8List queryAccountRequestDescriptor = $convert.base64Decode('ChNRdWVyeUFjY291bnRSZXF1ZXN0EjIKB2FkZHJlc3MYASABKAlCGNK0LRRjb3Ntb3MuQWRkcmVzc1N0cmluZ1IHYWRkcmVzczoI6KAfAIigHwA=');
...
final $typed_data.Uint8List queryModuleAccountsRequestDescriptor = $convert.base64Decode('ChpRdWVyeU1vZHVsZUFjY291bnRzUmVxdWVzdA==');
...
final $typed_data.Uint8List queryModuleAccountsResponseDescriptor = $convert.base64Decode('ChtRdWVyeU1vZHVsZUFjY291bnRzUmVzcG9uc2USRAoIYWNjb3VudHMYASADKAsyFC5nb29nbGUucHJvdG9idWYuQW55QhLKtC0OTW9kdWxlQWNjb3VudElSCGFjY291bnRz');
@$core.Deprecated('Use queryModuleAccountByNameRequestDescriptor instead')
const QueryModuleAccountByNameRequest$json = const {
...
final $typed_data.Uint8List queryModuleAccountByNameRequestDescriptor = $convert.base64Decode('Ch9RdWVyeU1vZHVsZUFjY291bnRCeU5hbWVSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWU=');
@$core.Deprecated('Use queryModuleAccountByNameResponseDescriptor instead')
const QueryModuleAccountByNameResponse$json = const {
...
final $typed_data.Uint8List queryModuleAccountByNameResponseDescriptor = $convert.base64Decode('CiBRdWVyeU1vZHVsZUFjY291bnRCeU5hbWVSZXNwb25zZRJCCgdhY2NvdW50GAEgASgLMhQuZ29vZ2xlLnByb3RvYnVmLkFueUISyrQtDk1vZHVsZUFjY291bnRJUgdhY2NvdW50');
...
final $typed_data.Uint8List bech32PrefixRequestDescriptor = $convert.base64Decode('ChNCZWNoMzJQcmVmaXhSZXF1ZXN0');
...
final $typed_data.Uint8List bech32PrefixResponseDescriptor = $convert.base64Decode('ChRCZWNoMzJQcmVmaXhSZXNwb25zZRIjCg1iZWNoMzJfcHJlZml4GAEgASgJUgxiZWNoMzJQcmVmaXg=');
...
final $typed_data.Uint8List addressBytesToStringRequestDescriptor = $convert.base64Decode('ChtBZGRyZXNzQnl0ZXNUb1N0cmluZ1JlcXVlc3QSIwoNYWRkcmVzc19ieXRlcxgBIAEoDFIMYWRkcmVzc0J5dGVz');
...
const AddressBytesToStringResponse$json = const {
  ...
  '2': const [
    const {'1': 'address_string', '3': 1, '4': 1, '5': 9, '10': 'addressString'},
  ],
};

/// Descriptor for `AddressBytesToStringResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List addressBytesToStringResponseDescriptor = $convert.base64Decode('ChxBZGRyZXNzQnl0ZXNUb1N0cmluZ1Jlc3BvbnNlEiUKDmFkZHJlc3Nfc3RyaW5nGAEgASgJUg1hZGRyZXNzU3RyaW5n');
...
final $typed_data.Uint8List addressStringToBytesRequestDescriptor = $convert.base64Decode('ChtBZGRyZXNzU3RyaW5nVG9CeXRlc1JlcXVlc3QSJQoOYWRkcmVzc19zdHJpbmcYASABKAlSDWFkZHJlc3NTdHJpbmc=');
...
final $typed_data.Uint8List addressStringToBytesResponseDescriptor = $convert.base64Decode('ChxBZGRyZXNzU3RyaW5nVG9CeXRlc1Jlc3BvbnNlEiMKDWFkZHJlc3NfYnl0ZXMYASABKAxSDGFkZHJlc3NCeXRlcw==');
...
final $typed_data.Uint8List queryAccountAddressByIDRequestDescriptor = $convert.base64Decode('Ch5RdWVyeUFjY291bnRBZGRyZXNzQnlJRFJlcXVlc3QSDgoCaWQYASABKANSAmlk');
...
const QueryAccountAddressByIDResponse$json = const {
  ...
  '2': const [
    const {'1': 'account_address', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'accountAddress'},
  ],
};

/// Descriptor for `QueryAccountAddressByIDResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryAccountAddressByIDResponseDescriptor = $convert.base64Decode('Ch9RdWVyeUFjY291bnRBZGRyZXNzQnlJRFJlc3BvbnNlEkEKD2FjY291bnRfYWRkcmVzcxgBIAEoCUIY0rQtFGNvc21vcy5BZGRyZXNzU3RyaW5nUg5hY2NvdW50QWRkcmVzcw==');
